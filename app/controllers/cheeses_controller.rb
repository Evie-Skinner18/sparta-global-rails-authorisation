class CheesesController < ApplicationController
  ...
  #YOU CAN ONLY MAKE A CHEESE IF YOU ARE SIGNED IN
  ...
  def create
    ...
    respond_to do |format|
      if @cheese.save
        format.html { redirect_to @cheese, notice: 'Cheese was successfully created. Tasty!' }
  ...
  def update
    respond_to do |format|
      if @cheese.update(cheese_params)
        format.html { redirect_to @cheese, notice: 'Cheese was successfully updated. Smooth.' }
  ...
  def destroy
    @cheese.destroy
    respond_to do |format|
      format.html { redirect_to cheeses_url, notice: 'Cheese was successfully destroyed, muhahaha!' }
  ...
  private
    ...
    def cheese_params
      params.require(:cheese).permit(:name, :country, :strength, :user_id)
    end
end
