...
class CheesesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cheese" do
    assert_difference('Cheese.count') do
      post cheeses_url, params: { cheese: { country: @cheese.country, name: @cheese.name, strength: @cheese.strength, user_id: @cheese.user_id } }
    end
  ...
  test "should update cheese" do
    patch cheese_url(@cheese), params: { cheese: { country: @cheese.country, name: @cheese.name, strength: @cheese.strength, user_id: @cheese.user_id } }
